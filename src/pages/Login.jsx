   ...
   return (
      <div className='mt-20'>
         ...
         <div
            ...
            className='inline-flex bg-white text-primary cursor-pointer rounded-sm p-2 gap-3 items-center mt-10 justify-center px-10
         '>
            <img
         ...
         <Divider
            textAlign='left'
            sx={{ "&::before, &::after": { borderColor: "white" }, mt: 3 }}>
            OR
         </Divider>
         <form
